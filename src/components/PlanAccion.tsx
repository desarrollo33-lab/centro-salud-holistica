  ...
  if (step === 5 && plan) return (
    <div>
      <div className="text-center mb-8">
        <div className="mb-4 flex justify-center"><PartyPopper className="w-12 h-12 text-primary-500" aria-hidden="true" /></div>
        <h2 className="text-2xl font-heading text-neutral-900 mb-2">¡Tu Plan está Listo!</h2>
      </div>
      {plan.readings?.length > 0 && (
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 inline-flex items-center gap-2"><BookOpen className="w-5 h-5 text-primary-500" aria-hidden="true" /> Lecturas Recomendadas</h3>
      ...
      {plan.supplements?.length > 0 && (
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 inline-flex items-center gap-2"><ClipboardList className="w-5 h-5 text-primary-500" aria-hidden="true" /> Suplementos</h3>
